...
the claim that macroecology can be explained by individ‐ uals and population dynamics can be demonstrated rigorously to be possible only rarely, owing to the transmutation problem
